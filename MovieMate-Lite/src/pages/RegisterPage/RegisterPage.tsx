...
// ── NoFillTextField types ──
interface NoFillTextFieldProps {
...
const NoFillTextField = ({
  inputRef: externalRef,
  ...props
}: NoFillTextFieldProps) => {
...
const Step1 = ({
  ...
  return (
    <>
      ...
      <Button variant="contained" fullWidth sx={{ mt: 2 }} onClick={onNext}>
        NEXT →
      </Button>
    </>
  );
...
const Step2 = ({ register, errors, onBack, onSubmit }: Step2Props) => (
  <>
      ...
      <div className={styles.container}>
        <Paper elevation={3} className={styles.paper}>
          ...
          <div className={styles.stepIndicator}>
            {[1, 2].map((s) => (
              <Box
                ...
                sx={{
                  bgcolor:
                    state.step === s ? "primary.main" : "action.selected",
                  color: state.step === s ? "#fff" : "text.secondary",
                }}
              >
                {s}
              </Box>
          ...
          <Typography variant="h6" align="center" fontWeight={700} mb={2}>
            {state.step === 1 ? "Account Details" : "Personal Details"}
          </Typography>
